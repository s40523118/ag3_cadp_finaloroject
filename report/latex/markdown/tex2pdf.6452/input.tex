...
\hypersetup{
            pdfauthor={設計二乙 40523107 鄭佩宜; 設計二乙 40523108 王信為; 設計二乙 40523109 王振偉; 設計二乙 40523116 辛泊剛; 設計二乙 40523117 周哲宇; 設計二乙 40523118 林兆戎.},
            pdfborder={0 0 0},
            breaklinks=true}
...
\fontsize{24}{36}\selectfont{電腦輔助設計實習 ag3 期末報告\par}
\vspace{1.5cm}
...
\fontsize{18}{27}\selectfont{
    學生：\par
    設計二乙 40523107 鄭佩宜 \par 設計二乙 40523108 王信為 \par 設計二乙 40523109 王振偉 \par 設計二乙 40523116 辛泊剛 \par 設計二乙 40523117 周哲宇 \par 設計二乙 40523118 林兆戎. \par
    指導教授：嚴家銘\par
}
\vspace{1.5cm}
...
\fontsize{14}{21}\selectfont{我們這組以類似挖土機的方式將球從起始點帶上高處，在設計出一條專屬的軌道，使球在軌道中運行可以再度回到起始點，周而復始。
...
\begin{figure}
\centering
\includegraphics{./tex2pdf.6452/e0ef408d9559203849a0aa26f79f9b032b709c7a.png}
